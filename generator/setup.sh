...
g++ -I/usr/include/python3.5m -o checkers_game_obj checkers_game_obj.cpp json-to-stl.cpp move-generator.cpp checkers-game.cpp board.cpp utils.cpp player.cpp -lpython3.5m -std=c++14
