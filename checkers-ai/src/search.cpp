...
CheckersGame::JumpPackage ai::getBestJump(CheckersGame &game, int depth,
        int space) {
...
SearchHelper::SearchHelper(char maximizingPlayer, CheckersGame &game)
    ...
    EvaluationType SearchHelper::recurse(const MovePackage &move, int depth,
...
EvaluationType SearchHelper::recurse(const JumpPackage &jump, int depth,
        EvaluationType alpha,
        EvaluationType beta) {
    ++totalNodes;
...
EvaluationType
SearchHelper::recurseMultiJumpCase(const vector<JumpPackage> &multiJumps,
        int depth, EvaluationType alpha,
        EvaluationType beta) {
...
EvaluationType SearchHelper::recursiveCase(int depth, EvaluationType alpha,
        EvaluationType beta) {
...
GameState SearchHelper::getCurrentGameState() { return game.getState(); }
...
void SearchHelper::setGameState(GameState &state) { game.setState(state); }
